    ...
    await axios
      .post(
        "https://api.brevo.com/v3/smtp/email",
        {
          ...
          subject: `Anmodet marketingsanalyse fra ${
            jsonData?.fullName || "Ukendt person"
          }`,
          htmlContent: `
                ...
                <br />
                Fuldt navn:&nbsp;</strong>${
                  jsonData?.fullName || "Ikke angivet"
                }<br />
                <strong>Email:&nbsp;</strong>${
                  jsonData?.email || "Ikke angivet"
                }<br />
                <strong>Virksomhed:&nbsp;</strong>${
                  jsonData?.company || "Ikke angivet"
                }<br />
                <strong>Tlf. nr.:&nbsp;</strong>${
                  jsonData?.phoneNumber || "Ikke angivet"
                }<br />
                <strong>Hjemmeside:&nbsp;</strong>${
                  jsonData?.website || "Ikke angivet"
                }<br />
                <strong>M&aring;nedligt ad spend:&nbsp;</strong>${
                  jsonData?.monthlyAdSpend || "Ikke angivet"
                }<br />
                <br />
