    ...
    <section className="py-[100px] pt-[160px]">
      <div className="w-[90%] mx-auto max-w-main">
        <div className="mb-[60px] text-center ctaOne:text-left">
          ...
          <p className="text-description text-gray-600 mx-auto font-[500] w-[70%] ctaOne:text-left ctaOne:w-[90%] ctaOne:mr-auto ctaOne:ml-0 mde:text-[17px]">
            {currentPath === "/en"
        ...
        <div className="grid grid-cols-3 gap-[30px] teamOne:grid-cols-1">
          ...
          <div className="p-[50px] bg-[#f7f7fc] rounded-[8px] flex items-center gap-[20px] border-[1px]">
            ...
            <div>
              ...
              <p className="text-[20px] text-gray-600">Head of Google</p>
            </div>
          </div>
          <div className="p-[50px] bg-[#f7f7fc] rounded-[8px] flex items-center gap-[20px] border-[1px]">
            <img
            ...
            ></img>
            <div>
              <h1 className="text-[26px] font-[600] mb-[0px]">Lucas Krøll</h1>
              <p className="text-[20px] text-gray-600">
