      ...
      <section className="bg-[#f7f7fc] py-[100px]">
        <div className="w-[90%] mx-auto">
          <div className="flex items-center justify-end gap-2 mb-4">
            <div className="p-4 bg-white border border-gray-300 rounded shadow cursor-pointer active:scale-95">
  ...
  return (
    <>
      <div className="mb-[100px] bg-white p-[30px] rounded-[8px] text-black border-[1px]">
        <img className="w-[120px] select-none mb-[20px]" src={object.image}></img>
